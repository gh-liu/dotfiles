...
function progress() {
  ...
  live.progress("job-1", "Thinking", { kind: "thinking", status: "completed" }, undefined, [
  ...
  live.progress("job-2", "web_search Pi SDK lifecycle…", { kind: "tool", status: "running" }, undefined, [
    { kind: "thinking", text: "hidden" },
