...
export function registerSubagentExtension(pi: ExtensionAPI, options: SubagentExtensionOptions = {}): void {
  ...
  pi.registerTool({
    ...
    promptSnippet: "Delegate: multi-file reads, batch edits, test runs, independent reviews, multi-source research; keep only single-file lookups/edits direct; NEVER call list, catalog is in description",
    promptGuidelines: [
